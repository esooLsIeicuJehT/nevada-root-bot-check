...
echo "=== SOURCE CLEANUP ==="
# These are generated by our earlier in-tree config step. AOSP refuses
# out-of-tree builds while they exist. Remove only generated artifacts,
# preserving all KernelSU Next and SUSFS source changes.
